...
class VisitControllerTest {
    ...
    // spy is on concrete class not on interface, when it was @Mock, it was on the interface
    @Spy
    ...
    void loadPetWithVisitWithStubbing() {
        //difference between this method and above method is that above method uses the real method to
        //to return the pet and this method we tell Mockito what to return on line 74
        //given
        Map<String, Object> model = new HashMap<>();
        Pet pet = new Pet(12L);
        Pet pet3 = new Pet(3L);
